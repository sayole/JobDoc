...
List<Map<String, dynamic>> internalCompanys1 = [
  ...
  {'name': 'SK', 'selected': false},
  {'name': '현대', 'selected': false},
  {'name': 'LG', 'selected': false},
  {'name': '롯데', 'selected': false},
  {'name': '포스코', 'selected': false},
  {'name': '한화', 'selected': false},
  {'name': 'GS', 'selected': false}
];

List<Map<String, dynamic>> internalCompanys2 = [
  {'name': '농협', 'selected': false},
  {'name': '신세계', 'selected': false},
  {'name': 'KT', 'selected': false},
  {'name': 'CJ', 'selected': false},
  {'name': '한진', 'selected': false},
  {'name': '두산', 'selected': false},
  {'name': 'LS', 'selected': false},
  {'name': '부영', 'selected': false},
];
List<Map<String, dynamic>> foreignCompanys1 = [
  {'name': '구글', 'selected': false},
  {'name': '애플', 'selected': false},
  {'name': '마이크로소프트', 'selected': false},
  {'name': '테슬라', 'selected': false},
  {'name': '아마존', 'selected': false},
];
List<Map<String, dynamic>> foreignCompanys2 = [
  {'name': '디즈니', 'selected': false},
  {'name': '넷플릭스', 'selected': false},
  {'name': '코카콜라', 'selected': false},
  {'name': 'GE', 'selected': false},
  {'name': '코카콜라', 'selected': false},
  {'name': '스타벅스', 'selected': false},
];
List<Map<String, dynamic>> unicornCompanys1 = [
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ...SubmitWidgets.companyWidget('해외 대기업', foreignCompanys1,
                  foreignCompanys2, selectCompanySwitch),
              ...SubmitWidgets.companyWidget('유니콘', unicornCompanys1,
                  unicornCompanys2, selectCompanySwitch),
            ],
          ),
        ),
